...
oh-my-claude/
  ...
  bundle/dot-claude/          # Installs to ~/.claude/
    ...
    quality-pack/
      ...
      scripts/                # 12 lifecycle scripts (prompt routing, first-prompt session-init, compaction, session start [5 hooks incl. drift-check + whats-new], stop-failure, resume-watchdog)
  ...
  tests/                      # 102 bash + 1 python test scripts; CLAUDE.md "Testing" lists each one
