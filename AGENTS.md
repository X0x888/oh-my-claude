...
oh-my-claude/
  ...
  bundle/dot-claude/          # Installs to ~/.claude/
    ...
    skills/                   # 30 skill definitions, each in <name>/SKILL.md
      autowork/scripts/       # 39 autowork hook scripts and utilities
  ...
  tests/                      # 138 bash + 1 python test scripts; CLAUDE.md "Testing" lists each one
