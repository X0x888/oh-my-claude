...
oh-my-claude/
  ...
  bundle/dot-claude/          # Installs to ~/.claude/
    ...
    quality-pack/
      ...
      scripts/                # 10 lifecycle scripts (prompt routing, compaction, session start [4 hooks incl. drift-check], stop-failure, resume-watchdog)
  ...
  tests/                      # 82 bash + 1 python test scripts; CLAUDE.md "Testing" lists each one
