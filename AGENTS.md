...
oh-my-claude/
  ...
  bundle/dot-claude/          # Installs to ~/.claude/
    ...
    quality-pack/
      ...
      scripts/                # 13 lifecycle scripts (prompt routing, compaction, session start [7 hooks incl. drift-check + whats-new + orphan-resume + orphan-tmp cleanup], stop-failure, resume-watchdog)
  ...
  tests/                      # 100 bash + 1 python test scripts; CLAUDE.md "Testing" lists each one
