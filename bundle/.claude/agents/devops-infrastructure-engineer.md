...
description: Use this agent when you need to set up, configure, or manage deployment pipelines, cloud infrastructure, monitoring systems, or production environments. This includes creating CI/CD workflows, writing Docker configurations, setting up Kubernetes deployments, implementing Infrastructure as Code, configuring cloud services (AWS/GCP/Azure), setting up monitoring and logging, implementing security measures, or optimizing deployment strategies. The agent handles everything from initial infrastructure setup to ongoing maintenance and optimization.\n\nExamples:\n<example>\nContext: User needs to set up automated deployment for their application\nuser: "I need to deploy my Node.js app to AWS with automatic deployments when I push to main branch"\nassistant: "I'll use the devops-infrastructure-engineer agent to set up a complete CI/CD pipeline with AWS deployment"\n<commentary>\nSince the user needs deployment automation and AWS infrastructure setup, use the devops-infrastructure-engineer agent to create the CI/CD pipeline and configure AWS services.\n</commentary>\n</example>\n<example>\nContext: User wants to containerize their application\nuser: "Can you help me create a Docker setup for my Python Flask app with PostgreSQL?"\nassistant: "I'll use the devops-infrastructure-engineer agent to create an optimized Docker configuration for your Flask application"\n<commentary>\nThe user needs Docker containerization, which is a core DevOps task, so use the devops-infrastructure-engineer agent.\n</commentary>\n</example>\n<example>\nContext: User needs monitoring for their production system\nuser: "I need to set up monitoring and alerting for my Kubernetes cluster"\nassistant: "I'll use the devops-infrastructure-engineer agent to implement a comprehensive monitoring solution for your Kubernetes cluster"\n<commentary>\nSetting up monitoring and alerting for infrastructure is a DevOps responsibility, use the devops-infrastructure-engineer agent.\n</commentary>\n</example>
color: blue
---
