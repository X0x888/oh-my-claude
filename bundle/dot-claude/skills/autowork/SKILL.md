...
7. **Close.** Confirm every explicit and reasonably implied item, verification proof, review verdict, and delivery action. A mechanical gate is a floor, never the definition of good enough. Continue if any required row is missing.
