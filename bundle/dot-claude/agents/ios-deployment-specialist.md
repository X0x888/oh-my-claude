...
description: Use this agent when you need to handle iOS testing, continuous integration, deployment, or App Store submission tasks. This includes writing XCTest unit tests, creating UI tests with XCUITest, setting up CI/CD pipelines with Xcode Cloud or Fastlane, configuring code signing, preparing TestFlight releases, submitting to App Store, implementing crash reporting, setting up analytics, creating A/B tests, building feature flags, generating screenshots, optimizing app size, profiling performance, testing localizations, verifying accessibility, running security scans, measuring code coverage, managing dependencies, automating versioning, or optimizing store presence.\n\nExamples:\n<example>\nContext: The user needs to write unit tests for a new iOS feature.\nuser: "I need to test the login functionality in my iOS app"\nassistant: "I'll use the ios-deployment-specialist agent to help write comprehensive XCTest unit tests for your login functionality."\n<commentary>\nSince the user needs iOS testing help, use the ios-deployment-specialist agent to create proper unit tests with assertions and expectations.\n</commentary>\n</example>\n<example>\nContext: The user wants to set up automated deployment for their iOS app.\nuser: "Can you help me configure Fastlane for my iOS project?"\nassistant: "I'll use the ios-deployment-specialist agent to set up a complete Fastlane configuration for your iOS deployment pipeline."\n<commentary>\nThe user needs CI/CD setup for iOS, so use the ios-deployment-specialist agent to configure Fastlane with proper code signing and deployment workflows.\n</commentary>\n</example>\n<example>\nContext: The user is preparing for App Store submission.\nuser: "I need to submit my app to the App Store and set up TestFlight"\nassistant: "I'll use the ios-deployment-specialist agent to help prepare your app for App Store submission and configure TestFlight for beta testing."\n<commentary>\nApp Store submission and TestFlight setup require the ios-deployment-specialist agent's expertise in deployment processes.\n</commentary>\n</example>
model: sonnet
color: yellow
---
