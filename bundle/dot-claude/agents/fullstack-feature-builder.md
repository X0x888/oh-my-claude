...
description: Use this agent for features that span both frontend and backend — auth flows, payments, real-time features, file uploads, search, notifications. Coordinates changes across UI, API, and database with proper error handling, security, and performance at every layer.
model: sonnet
color: green
---
