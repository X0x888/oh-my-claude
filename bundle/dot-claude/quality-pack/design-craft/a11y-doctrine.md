<!--
oh-my-claude design-craft reference — A11Y doctrine
...
MAY-FIX semantics), §2 AI Behavior Contract (6 rules constraining how AI agents
reason about a11y), §3 Technical Standards under the POUR framework (Perceivable
/ Operable / Understandable / Robust), §5 Complex Component Protocol, §6
Anti-patterns (Clickable Divs, Leaked Focus Traps, Placeholder Labels, Reinventing
the Complex Wheel), §7 Verification Workflow (5-item Definition of Done).

Read this on-demand when the design surfaces are evaluating accessibility, or
when ios-ui-developer / frontend-developer is producing UI that needs to meet
WCAG 2.2 AA / ISO 9241-171 / ADA / EAA. Update by re-pulling from upstream main.
-->
