...
- `bundle/dot-claude/quality-pack/scripts/` — 13 lifecycle hooks (prompt routing, compaction, session start incl. drift-check + whats-new + orphan-resume + orphan-tmp cleanup, StopFailure capture, resume hint, headless watchdog)
