...
- `bundle/dot-claude/quality-pack/scripts/` — 12 lifecycle hooks (prompt routing, compaction, session start incl. drift-check + whats-new + orphan-resume cleanup, StopFailure capture, resume hint, headless watchdog)
