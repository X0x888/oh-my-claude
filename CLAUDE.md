...
- `bundle/dot-claude/quality-pack/scripts/` — 12 lifecycle hooks (prompt routing, first-prompt session-init, compaction, session start incl. drift-check + whats-new, StopFailure capture, resume hint, headless watchdog)
