...
assert_council "evaluate my project --deep"
assert_council "evaluate my project --polish"
assert_council "evaluate my project --self-audit"
assert_council "evaluate my project thoroughly"
assert_council "review my codebase carefully"
assert_council "audit this project deeply"

printf '\nCouncil positives (new project-level nouns):\n'
assert_council "evaluate my Chrome extension end to end"
assert_council "evaluate my open-source project"
assert_council "review my Node.js application"
assert_council "audit our production codebase"
assert_council "assess the legacy system"
assert_council "review our operating system"
assert_council "review our system"
assert_council "audit the whole system"
assert_council "assess our production system"
assert_council "evaluate the public website"
assert_council "review my e-commerce platform"
assert_council "analyze our multi-tenant SaaS application"
assert_council "review my Python command-line app"
assert_council "find all gaps in my project"
assert_council "find the gaps in my codebase"
assert_council "identify any blind spots across the app"
assert_council "surface all weaknesses"
assert_council "uncover every gap"
assert_council "where can we improve the project"
assert_council "how can we improve our app"
assert_council "what is missing from this project"
assert_council "are there gaps in our product"

assert_not_council "review the mobile app login flow"
assert_not_council "audit our website checkout"
assert_not_council "assess the product onboarding"
assert_not_council "review the library API design"
assert_not_council "review our system architecture"
assert_not_council "review our design system"
assert_not_council "evaluate the build system"
assert_not_council "do a full review of our build system"
assert_not_council "review our production build system"
assert_not_council "perform a comprehensive assessment of the recommendation system"
assert_not_council "audit the codebase authentication layer"
assert_not_council "review everything in this PR"
...
printf '\nCouncil negatives (focused feature/capability/surface/subsystem scope):\n'
assert_not_council "evaluate this feature"
assert_not_council "audit the agent memory wall feature"
assert_not_council "review the auth capability"
assert_not_council "assess the API surface"
assert_not_council "evaluate the auth subsystem"
assert_not_council "comprehensive review of this feature"
assert_not_council "full audit of this subsystem"
assert_not_council "holistic assessment of this API surface"
assert_not_council "overall assessment of this module"
...
printf '\nCouncil negatives (Pattern 6 — focused or ambiguous targets):\n'
assert_not_council "make this feature impeccable to use"
assert_not_council "make it impeccable"
assert_not_council "make my parser production ready"
assert_not_council "make our checkout production-ready"
assert_not_council "make the login flow polished"
assert_not_council "make our payment integration flawless"
assert_not_council "make the API client excellent"
assert_not_council "make our backend production grade"
assert_not_council "review the login flow carefully"
assert_not_council "audit our checkout deeply"
...
printf '\nCouncil positives (structural project targets and subordinate focus):\n'
assert_council "review my fintech app"
assert_council "evaluate our customer-facing application"
assert_council "audit the whole fintech app"
assert_council "assess my iPhone application"
assert_council "do a comprehensive review of my project, with special attention to security"
assert_council "full project review with recommendations about architecture"

printf '\nCouncil negatives (project-word compounds):\n'
assert_not_council "review my system prompt"
assert_not_council "audit the application form"
assert_not_council "assess our product page"
assert_not_council "inspect my library card"
assert_not_council "review our platform roadmap"
assert_not_council "assess the framework documentation"
...
assert_not_council "comprehensive review of authentication"
assert_not_council "comprehensive review of the authentication system"
assert_not_council "holistic assessment of security"
assert_not_council "full audit of API performance"
assert_not_council "overall analysis of caching"
assert_not_council "broad review of data validation"
assert_not_council "find gaps in the login flow"
assert_not_council "identify blind spots in checkout"
assert_not_council "surface weaknesses in onboarding"
assert_not_council "find what is missing from the upload flow"
assert_not_council "what should I improve in the checkout journey"
assert_not_council "evaluate my authentication system"
assert_not_council "review the checkout application flow"
assert_not_council "audit our payment platform integration"
assert_not_council "assess the logging framework configuration"

printf '\nCouncil positives (whole-project controls for generic narrowing):\n'
assert_council "comprehensive review of the project"
assert_council "holistic assessment of our entire application"
assert_council "find gaps in the codebase"
assert_council "what should I improve about my product"
assert_council "review the whole mobile app"
assert_council "audit everything"
assert_council "review everything end to end"
assert_council "do an end-to-end audit"
assert_council "inspect all aspects of the application"
assert_council "end-to-end project review"
assert_council "comprehensive review of everything"
assert_council "full audit of all subsystems"
assert_council "holistic assessment of every surface"
assert_council "complete evaluation of all features"
assert_council "evaluate my Chrome extension end to end"
