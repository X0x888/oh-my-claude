...
OMC_REF=v1.47.0 bash -c "$(curl -fsSL https://raw.githubusercontent.com/X0x888/oh-my-claude/main/install-remote.sh)"
...
git clone --branch v1.47.0 https://github.com/X0x888/oh-my-claude.git ~/.local/share/oh-my-claude
...
├── tests/               (145 bash + 1 py)   # See AGENTS.md / CONTRIBUTING.md for full list
