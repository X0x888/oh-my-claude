...
OMC_REF=v1.44.0 bash -c "$(curl -fsSL https://raw.githubusercontent.com/X0x888/oh-my-claude/main/install-remote.sh)"
...
git clone --branch v1.44.0 https://github.com/X0x888/oh-my-claude.git ~/.local/share/oh-my-claude
...
├── tests/               (138 bash + 1 py)   # See AGENTS.md / CONTRIBUTING.md for full list
